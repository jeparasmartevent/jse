...
class Home extends CI_Controller {
	...
	{	
		...
		$data['get_sitename'] = $this->model_settings->sitename_settings();
		$data['get_footer'] = $this->model_settings->footer_settings();	
		$data['view_v'] = $this->model_products->detail($pro_id);	
		$data['starts'] = $this->model_products->dis_products();
		$this->load->view('view_products',$data); //this $data from model inside class model_products
		
		
		
	}
	
	public function category($pro_name)
	{		
			$data['get_sitename'] = $this->model_settings->sitename_settings();
			$data['get_footer'] = $this->model_settings->footer_settings();	
			$data['starts'] = $this->model_products->dis_products();
