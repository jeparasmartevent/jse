		...
		if($this->form_validation->run()	==	FALSE)
		{
			...
			if($valid_user	==	FALSE)
			{
				if ($check_user_is_active == FALSE)
				{
						...
						$this->session->set_flashdata('msg_login','<div class="alert alert-success text-center">You are account is not active! <a href="https://mail.google.com/">Please confirm the mail sent to your Email-ID</a>!!!</div>');
				...
				$this->session->set_userdata('email',$valid_user->usr_email);
