    ...
    <div class="container">
       ...
       <hr>
        ...
        <div class="well">
            <div class="row">
                <div class="col-md-8">
                    <p>Silahkan tekan tombol disamping untuk melihat detail pembayaran melaluai Email anda.</p>
                </div>
                <div class="col-md-4">
                    <a class="btn btn-lg btn-success btn-block" href="https://mail.google.com/">Check Your Email</a>
                </div>
            </div>
        </div>
