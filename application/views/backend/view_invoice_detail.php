							...
							<table class="table table-striped table-hover" id="table-invoice">
								...
								?>
									<tr>
										...
										<?php if ($invoices->status == 'unpaid'):?>
								
																		
										<?=  anchor('#','unpaid ',['class'=>'btn btn-warning btn-xs disabled'])  ?>

										<?=  anchor('admin/invoices/waiting/'.$invoices->id,'waiting ',['class'=>'btn btn-primary btn-xs ',
											'onclick'=>'return confirm(\'Are You Sure You Want WAITING This  products ? \')'
										])  ?>

										<?=  anchor('admin/invoices/confirmed/'.$invoices->id,'confirmed ',['class'=>'btn btn-success btn-xs ',
											'onclick'=>'return confirm(\'Are You Sure You Want CONFIRMED This  products ? \')'
										])  ?>
										...
										<?=  anchor('#','confirmed',['class'=>'btn btn-success btn-xs disabled'
										])  ?>

										<?php else:?>
										<?=  anchor('#','unpaid ',['class'=>'btn btn-warning btn-xs disabled'])  ?>

										<?=  anchor('#','waiting ',['class'=>'btn btn-primary btn-xs disabled'])  ?>
